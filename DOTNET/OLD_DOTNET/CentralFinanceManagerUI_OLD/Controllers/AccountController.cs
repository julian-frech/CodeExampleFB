    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //The method returns a result which is of type IdentityResult.It has two properties.
                //One is Succeeded which is boolean value and the other is errors property, which is a collection of errors
