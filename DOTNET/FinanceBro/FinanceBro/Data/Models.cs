...
namespace FinanceBro.Data
{
    ...
    public class UserDepotD
    {

        public UserDepotD() { }

        public UserDepotD(string _userHK)
        {
            this.UserHK = _userHK;
        ...
        public UserDepotD(string _UserHK,DateTime _ValidFrom, DateTime _ValidTo, DateTime _ITS, DateTime _UTS)
        {
            this.UserHK = _UserHK;
